...
const PaidUsersPage = lazy(() => import("./pages/PaidUserData/index"))
const BranchPage = lazy(() => import("./pages/All Branch/index"))
const SettingPage = lazy(() => import("./pages/SettingPage/SendMailSet/Index"))
const PendingOrderPage = lazy(() => import("./pages/PendingOrders/index"))
const BookingPage = lazy(() => import("./pages/Booking Files/index"))
const ReturnAndPendingPage = lazy(() => import("./pages/Return & Pending/index"))
const PaymentSheetPage = lazy(() => import("./pages/Payment Sheets/index"))
const AllUserPage = lazy(() => import("./pages/UserPage/index"))
const Ecommerce = lazy(() => import("./pages/dashboard/ecommerce"));
const WorkDashboard = lazy(() => import("./pages/EmployeeWork/WorkDashboard"));
    ...
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          <Route path="allemployee" element={<AllUserPage />} />

          <Route path={"profile/:id"} element={<Profile />} />
          <Route path="paymentorders" element={<PaymentSheetPage />} />
          <Route path="returnorders" element={<ReturnAndPendingPage />} />
          <Route path="bookingorder" element={<BookingPage />} />
          <Route path="pendingorders" element={<PendingOrderPage />} />
          <Route path="settings" element={<SettingPage />} />
          <Route path="branch" element={<BranchPage />} />
          <Route path="paiduser" element={<PaidUsersPage />} />
          <Route path="workdashboard" element={<WorkDashboard />} />
          <Route path="dashboard" element={<Dashboard />} />
          <Route path="orderdashboard" element={<Ecommerce />} />
          ...
          <Route path="trackorder" element={<FormWizard />} />
