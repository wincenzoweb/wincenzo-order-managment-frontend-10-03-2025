...
import { deleteBranch, getAllBranch, toggleConfirmModal } from "./BranchReducer/branchSlice";



const DeleteConfirm = () => {
    const { confirmModel, itemId } = useSelector((state) => state.branches);
    const dispatch = useDispatch();


    const handleDelete = () => {
        if (typeof itemId === 'string') {
            dispatch(deleteBranch(itemId));
        }
