...
const BookingList = () => {
    ...
    const { bookingdata, isLoading, currentPage, totalData, totalPages, duplicateBarcodeNumbers, totalSameDuplicateNumbers } = useSelector((state) => state.bookingdata);
    ...
    const shouldShowLoader = isLoading || !bookingdata || bookingdata.length === 0;
