...
import { deleteBookingData, deleteBookingDataList, getPaginatedBookingData, toggleConfirmModal } from "./BookingReducer/BookingSlice";


const DeleteConfirm = () => {
    const { confirmModel, itemId, currentPage, pageLimit } = useSelector((state) => state.bookingdata);
    ...
    const handleDelete = () => {
        if (typeof itemId === 'string') {
            ...
            dispatch(deleteBookingDataList(itemId));
        }
