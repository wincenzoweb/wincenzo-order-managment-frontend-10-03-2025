...
import { getPaginatedBookingData, toggleEditModal, updateBookingData } from "./BookingReducer/BookingSlice";

const EditBookingData = () => {
    const { editModal, editItem, currentPage, pageLimit } = useSelector((state) => state.bookingdata);
    ...
    const onSubmit = (data) => {
        ...
        dispatch(updateBookingData(user));
        ...
        <div>
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <button className="btn btn-dark block w-full text-center">Update Booking</button>
                </form>
            </Modal>
        </div>
    );
