...
import { deletePaymentData, deletePaymentDataList, getPaginatedPaymentData, toggleConfirmModal } from "./PaymentReducer/PaymentSlice";


const DeleteConfirm = () => {
    const { confirmModel, itemId, currentPage, pageLimit } = useSelector((state) => state.paymentdata);
    const dispatch = useDispatch();


    const handleDelete = () => {
        if (typeof itemId === 'string') {
            dispatch(deletePaymentData(itemId));
        } else if (Array.isArray(itemId)) {
            dispatch(deletePaymentDataList(itemId));
        }
