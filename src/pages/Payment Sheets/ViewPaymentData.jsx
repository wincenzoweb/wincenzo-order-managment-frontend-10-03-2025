...
import { toggleDetailModal } from "./PaymentReducer/PaymentSlice";

const ViewPaymentData = () => {
    const { detailModal, detailItem } = useSelector((state) => state.paymentdata);
            ...
            >
                <form className="space-y-5">
                    <div className="grid lg:grid-cols-2 md:grid-cols-2 gap-4 grid-cols-1">
                        {/* Previous Textinput components with disabled attribute */}
                        <Textinput
                            name="article_number"
                            ...
                            register={register}
                            defaultValue={detailItem?.article_number}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.article_type}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.booking_office_id}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.booking_office_name}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.Payment_office_pin}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.booking_time}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.delivery_office_id}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.delivery_office_name}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.delivery_office_pin}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.gross_amount}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.commission}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.amount_lc_1}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.amount_lc_2}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.round_off_amount}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.net_payable}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.payment_office_id}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.payment_office_name}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.payment_document_no}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.payment_cheque_no}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.liability_document}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.system_postings}
                        ...
                        <Textinput
                            ...
                            register={register}
                            defaultValue={detailItem?.status}
                            error={errors.status}
                            disabled
                        />
                    </div>
