...
import { deleteMultiplePendingOrder, deletePendingOrder, getPaginatedPendingOrders, toggleConfirmModal } from "./PendingOrderReducer/pendingOrderSlice";


const DeleteConfirm = () => {
    const { confirmModel, itemId, currentPage, pageLimit } = useSelector((state) => state.pendingorder);
    const dispatch = useDispatch();


    const handleDelete = () => {
        if (typeof itemId === 'string') {
            dispatch(deletePendingOrder(itemId));
        } else if (Array.isArray(itemId)) {
            dispatch(deleteMultiplePendingOrder(itemId));
        }
