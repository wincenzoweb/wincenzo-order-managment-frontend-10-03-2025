...
import { getPaginatedPendingOrders, toggleEditModal, updatePendingOrder } from "./PendingOrderReducer/pendingOrderSlice";

const EditPendingOrder = () => {
    const { editModal, editItem, currentPage, pageLimit } = useSelector((state) => state.pendingorder);
    ...
    const onSubmit = (data) => {
        ...
        dispatch(updatePendingOrder(user));
        ...
        <div>
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <button className="btn btn-dark block w-full text-center">Update Pending Order</button>
                </form>
            </Modal>
        </div>
    );
