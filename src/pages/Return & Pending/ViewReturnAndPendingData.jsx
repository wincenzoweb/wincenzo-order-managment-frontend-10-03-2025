...
import { toggleDetailModal } from "./ReturnAndPendingReducer/ReturnAndPendingSlice";


const ViewReturnAndPendingData = () => {
    const { detailModal, detailItem } = useSelector((state) => state.returnAndPendingdata);
...
export default ViewReturnAndPendingData;
