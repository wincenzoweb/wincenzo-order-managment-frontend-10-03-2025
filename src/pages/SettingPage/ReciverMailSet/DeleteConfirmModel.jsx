...
import { deleteReceiverMail, getAllReceiverMails, toggleConfirmModal } from "../SettingReducer/settingSlice";



const DeleteConfirm = () => {
    const { confirmModel, itemId } = useSelector((state) => state.setting);
    const dispatch = useDispatch();


    const handleDelete = () => {
        if (typeof itemId === 'string') {
            dispatch(deleteReceiverMail(itemId));
        }
                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 className="text-base font-semibold leading-6 text-gray-900">
                                    Delete Receiver Mail Id
                                </h3>
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Are you sure you want to Delete Receiver Mail Id?
